...
elseif(isstruct(runinputfile))
    opt=runinputfile;
    runinputfile=opt.runinputfile; %CHANGED BY ASH ON MAY 8, 2016 - commented out
...
disp(['runinput file: ' opt.runinputfile]) %CHANGED BY ASH ON MAY 8, 2016 - commented out
